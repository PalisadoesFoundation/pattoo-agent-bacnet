...
if EXEC_DIR.endswith('/pattoo-agent-bacnet/setup') is True:
...
Other steps:
    1) You can make the various pattoo agents be system daemons by running the
       ...
       https://github.com/PalisadoesFoundation/pattoo-agent-bacnet/tree/master/setup/systemd

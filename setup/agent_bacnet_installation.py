#!/usr/bin/env python3
"""Script to install the pattoo bacnet agent."""
...
_EXPECTED = '{0}pattoo-agent-bacnet{0}setup'.format(os.sep)
...
class _Install():
    ...
    def __init__(self, subparsers, width=80):
        ...
        parser = subparsers.add_parser(
            'install',
            help=textwrap.fill('Install pattoo bacnet agent.', width=width)
        )
        # Add subparser
...
def main():
    ...
    if args.action == 'install':
        ...
        # Installs all pattoo bacnetd agent components

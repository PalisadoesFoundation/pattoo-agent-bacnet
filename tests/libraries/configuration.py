...
NOTE!! This script CANNOT import any pattoo-agent-bacnet libraries. Doing so risks
...
class UnittestConfig():
    ...
    def __init__(self):
        ...
        config_suffix = '.pattoo-agent-bacnet-unittests{}config'.format(os.sep)
...
'''.format(screen_message, os.environ['PATTOO_CONFIGDIR']))
    ...
    if 'unittest' not in os.environ['PATTOO_CONFIGDIR']:
        ...
        log.log2die_safe(60025, log_message)

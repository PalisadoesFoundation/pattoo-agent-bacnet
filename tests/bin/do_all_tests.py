#!/usr/bin/env python3
"""Script to test all the pattoo-agent-bacnet unittests.
...
_EXPECTED = '{0}pattoo-agent-bacnet{0}tests{0}bin'.format(os.sep)
...
def main():
    """Test all the pattoo-agent-bacnet modules with unittests.
...
def run_script(cli_string):
    ...
    pattoo_returncode = ('----- pattoo-agent-bacnet Return Code '
                         '----------------------------------------')
    pattoo_stdoutdata = ('----- pattoo-agent-bacnet Test Output '
                         '----------------------------------------')
    pattoo_stderrdata = ('----- pattoo-agent-bacnet Test Error '
                         '-----------------------------------------')

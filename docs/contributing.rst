...
Below is the workflow for having your contribution accepted into the ``pattoo-agent-bacnet`` repository.
...
#. Add the original project as a remote (git remote add upstream https://github.com/PalisadoesFoundation/pattoo-agent-bacnet, check with: git remote -v)

...
_EXPECTED = '{0}pattoo-agent-bacnet{0}bin'.format(os.sep)
...
from pattoo_agent_bacnet.ip.configuration import ConfigBACnetIP as Config
from pattoo_agent_bacnet.ip import collector
